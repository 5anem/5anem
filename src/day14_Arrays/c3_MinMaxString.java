...
public class c3_MinMaxString {
    public static void main(String[] args) {
         ...
         //ex         String[] names = {"hello", "world", "java", "pyton", "sevgin", "renastechschool"};//output :renastechschool//write a program that can return the shortest string of text from an array
       ...
       //output : JS
            ...
            //lets assume farz etmek   first word has min length
