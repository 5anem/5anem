...
public class ShoeObject2 {
    ...
    public static void main(String[] args) {
        day21_CustomClasses.Shoe shoe1=new day21_CustomClasses.Shoe();
        day21_CustomClasses.Shoe shoe2=new day21_CustomClasses.Shoe();
...
//        that will assign our variables
        ...
        day21_CustomClasses.Shoe[] shoes={shoe1 ,shoe2};
        shoes[0].getShoeInfo();
        System.out.println("shoes[1].size = " + shoes[1].size);

        //how can we store in arraylist
        ArrayList<day21_CustomClasses.Shoe> shoeArrayList=new ArrayList<>();
